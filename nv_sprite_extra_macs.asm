...
.macro nv_sprite_move_positive_y(info)
{
    ...
    nv_adc124s(nv_sprite_y_fp124s_addr(info), nv_sprite_vel_y_fp124s_addr(info), nv_sprite_y_fp124s_addr(info), scratch16_a, scratch16_b, false)
...
.macro nv_sprite_move_positive_x(info)
{
    ...
    nv_adc124s(nv_sprite_x_fp124s_addr(info), nv_sprite_vel_x_fp124s_addr(info), nv_sprite_x_fp124s_addr(info), scratch16_a, scratch16_b, false)
